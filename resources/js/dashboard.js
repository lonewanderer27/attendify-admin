...
document.getElementById('eventForm').addEventListener('submit', function (event) {
    ...
    const organizer_approval = document.getElementById('organizerApproval').checked;
    ...
    // Send a POST request
    axios.post('/_api/events', eventData)
        .then(response => {
            ...
            axios.post(`/_api/invited_guests/event/id/${eventId}`, guestsData)
                .then(response => {
                    console.log(response.data);
